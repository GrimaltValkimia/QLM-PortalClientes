/*
       ...
       Generated on: September 23, 2020 10:34:23.66
...
public final  class GxWebStd
{
                                           ...
                                           String sCallerPgm )
   {
      ...
      if ( ( httpContext.getWrapped( ) && ( ( nRTEnabled != 0 ) || ( nEnabled != 0 ) ) ) || ! httpContext.getWrapped( ) )
      {
         ...
         com.quilmesportal.GxWebStd.classAttribute( httpContext, sClassString);
         if ( ! (GXutil.strcmp("", sAlign)==0) )
         {
            com.quilmesportal.GxWebStd.styleAttribute( httpContext, sStyleString+"text-align:"+sAlign);
         }
         else
         {
            com.quilmesportal.GxWebStd.styleAttribute( httpContext, sStyleString);
         }
         httpContext.writeText( sTags) ;
         httpContext.writeText( httpContext.htmlEndTag( HTMLElement.INPUT)) ;
         if ( nAutoComplete == 0 )
         {
            com.quilmesportal.GxWebStd.gx_ctrl_attribute( httpContext, sCtrlName, "autocomplete", "off", false);
         }
      }
      if ( nEnabled == 0 )
      {
         ...
         if ( nFormat != 2 )
         {
            ...
            com.quilmesportal.GxWebStd.classAttribute( httpContext, ClassHTML);
            com.quilmesportal.GxWebStd.styleAttribute( httpContext, sOStyle);
            ...
            com.quilmesportal.GxWebStd.gx_start_js_anchor( httpContext, nJScriptCode, sEventJsCode, sUserOnClickCode, sLinkURL, sLinkTarget, "");
         }
         if ( nIsPassword == 0 )
         {
            if ( nFormat == 0 )
         ...
         if ( nFormat != 2 )
         {
            com.quilmesportal.GxWebStd.gx_end_js_anchor( httpContext, sEventJsCode, sUserOnClickCode, sLinkURL);
            httpContext.writeText( "</span>") ;
         }
      }
   }
                                     ...
                                     String sCallerPgm )
   {
      ...
      else
      {
         if ( nDisplay == 1 )
         {
            ...
            if ( GXutil.strcmp(sURL, "") != 0 )
            {
               com.quilmesportal.GxWebStd.styleAttribute( httpContext, "display:block;"+sStyleString);
            }
            else
            {
               com.quilmesportal.GxWebStd.styleAttribute( httpContext, "display:none;"+sStyleString);
            }
                                      ...
                                      String sCallerPgm )
   {
      ...
      if ( GXutil.strcmp(sBorderStyle, "rounded") == 0 )
      {
         ...
         httpContext.writeText( ")\" ") ;
         com.quilmesportal.GxWebStd.styleAttribute( httpContext, sStyleString);
         com.quilmesportal.GxWebStd.classAttribute( httpContext, sClassRoundedBtn);
      ...
      com.quilmesportal.GxWebStd.gx_on_js_event( httpContext, "onclick", sEventJsCode);
      httpContext.writeText( " ") ;
      httpContext.writeText( sTags) ;
      httpContext.writeText( httpContext.htmlEndTag( HTMLElement.INPUT)) ;
      com.quilmesportal.GxWebStd.gx_ctrl_attribute( httpContext, sCtrlName, "data-jsevent", sUserOnClickCode, false);
      if ( GXutil.strcmp(sBorderStyle, "rounded") == 0 )
      {
                                   ...
                                   String sInMaster )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         {
            httpContext.writeText( "<div") ;
            com.quilmesportal.GxWebStd.classAttribute( httpContext, ((httpContext.GX_msglist.getItemType((short)(i))==1) ? "gx-error-message" : "gx-warning-message"));
            httpContext.writeText( ">") ;
                                         ...
                                         String sCallerPgm )
   {
      ...
      while ( idxLst <= CObjCtrl.getItemCount() )
      {
         ...
         {
            httpContext.writeText( "<option value=\"") ;
            httpContext.writeValue( GXutil.rtrim( CObjCtrl.getItemValue((short)(idxLst)))) ;
         }
      ...
      com.quilmesportal.GxWebStd.gx_ctrl_attribute( httpContext, sCtrlName, "data-jsevent", sUserOnClickCode, false);
      com.quilmesportal.GxWebStd.gx_ctrl_attribute( httpContext, sCtrlName, "data-gxoch0", sEventJsCode, true);
      if ( nEnabled == 0 )
      {
         if ( ( GXutil.len( sClassString) != 0 ) && ( GXutil.strSearch( sClassString, "Readonly", 1) != 1 ) )
         {
                                        ...
                                        String sCallerPgm )
   {
      ...
      while ( idxLst <= LObjCtrl.getItemCount() )
      {
         ...
         {
            httpContext.writeText( "<option value=\"") ;
            httpContext.writeValue( GXutil.rtrim( LObjCtrl.getItemValue((short)(idxLst)))) ;
         }
                                 ...
                                 String sCallerPgm )
   {
      ...
      {
         com.quilmesportal.GxWebStd.gx_multimedia_upload_start( httpContext, sInternalName, nVisible, nWidth, sStyleString);
         ...
         httpContext.writeText( "</span>") ;
         httpContext.writeText( "</a>") ;
         com.quilmesportal.GxWebStd.gx_multimedia_upload_end( httpContext, sInternalName, sImageURL, sTooltipText, nWidth, nWidthUnit, nHeight, nHeightUnit, sUserOnClickCode, sEventName, sStyleString, sClassString, "", "", sAlign, sInputTags, nReadOnly, bIsBlob, "image/*", sCallerPgm);
      }
   }
                                          ...
                                          String sImgSrcSet )
   {
      ...
      {
         com.quilmesportal.GxWebStd.gx_start_js_anchor( httpContext, nJScriptCode, sEventJsCode, sUserOnClickCode, sLinkURL, sLinkTarget, "gx-image-link");
      }
      if ( ! (GXutil.strcmp("", sImageURL)==0) )
      {
                                                ...
                                                String sCallerPgm )
   {
      ...
      com.quilmesportal.GxWebStd.gx_single_line_edit( httpContext, sInternalName+"_GXI", sURL, sURL, sInputTags, sEventName, "", "", sTooltipText, "", sUserOnClickCode, 0, "field "+sClassString, sStyleString, "", "", "", 1, 1, 1, "text", "", nWidth, nWidthUnit, nHeight, nHeightUnit, 254, (byte)(0), (short)(2), 0, (byte)(1), (byte)(1), (byte)(0), true, "", sAlign, false, sCallerPgm);
                                ...
                                String sCallerPgm )
   {
      ...
      if ( ( nReadOnly == 0 ) && ( nEnabled == 1 ) )
      {
         com.quilmesportal.GxWebStd.gx_multimedia_upload_end( httpContext, sInternalName, sMultimediaURL, "", nWidth, nWidthUnit, nHeight, nHeightUnit, sUserOnClickCode, sEventName, sStyleString, sClassString, "", "", "", sInputTags, nReadOnly, bIsBlob, "video/*", sCallerPgm);
      }
   }
                                ...
                                String sCallerPgm )
   {
      ...
      if ( ( nReadOnly == 0 ) && ( nEnabled == 1 ) )
      {
         com.quilmesportal.GxWebStd.gx_multimedia_upload_end( httpContext, sInternalName, sMultimediaURL, "", nWidth, nWidthUnit, nHeight, nHeightUnit, sUserOnClickCode, sEventName, sStyleString, sClassString, "", "", "", sInputTags, nReadOnly, bIsBlob, "audio/*", sCallerPgm);
      }
   }

   public static void gx_file( HttpContext httpContext ,
                               String sInternalName ,
                               String sMultimediaURL ,
                               String sText ,
                               int nDisplay ,
                               ...
                               String sCallerPgm )
   {
      ...
      if ( ( nReadOnly == 0 ) && ( nEnabled == 1 ) )
      {
         com.quilmesportal.GxWebStd.gx_multimedia_upload_end( httpContext, sInternalName, sMultimediaURL, "", nWidth, nWidthUnit, nHeight, nHeightUnit, sUserOnClickCode, sEventName, sStyleString, sClassString, "", "", "", sInputTags, nReadOnly, bIsBlob, "*", sCallerPgm);
      }
   }
                                     ...
                                     String sCallerPgm )
   {
      ...
      if ( nFormat == 1 )
      {
         ...
         httpContext.writeText( "<div") ;
         com.quilmesportal.GxWebStd.classAttribute( httpContext, sClassString);
         com.quilmesportal.GxWebStd.styleAttribute( httpContext, sStyle);
      ...
      {
         com.quilmesportal.GxWebStd.gx_ctrl_attribute( httpContext, sInternalName, "data-gxformat", GXutil.str( nFormat, 1, 0), false);
      }
      if ( ( nFormat == 1 ) && ( ! (GXutil.strcmp("", sEventJsCode)==0) || ! (GXutil.strcmp("", sUserOnClickCode)==0) || ! (GXutil.strcmp("", sLinkURL)==0) ) )
      {
         com.quilmesportal.GxWebStd.gx_ctrl_attribute( httpContext, sInternalName, "gxlink", "1", false);
      }
   }
                                          ...
                                          String sClassString )
   {
      ...
      else
      {
         ...
         {
            com.quilmesportal.GxWebStd.gx_link_start( httpContext, sLinkURL, sLinkTarget, sClassString);
         }
      }
   }
                                        ...
                                        String sLinkURL )
   {
      ...
      {
         com.quilmesportal.GxWebStd.gx_link_end( httpContext, sLinkURL);
      }
   }
         ...
         else
         {
            if ( (GXutil.strcmp("", httpContext.getReferer( ))==0) || httpContext.isLocalStorageSupported( ) )
            {
               ...
               else
               {
                  ...
                  httpContext.AddJavascriptSource("jquery.js", "?"+httpContext.getBuildNumber( 126726), false);
                  httpContext.AddJavascriptSource("gxgral.js", "?"+httpContext.getBuildNumber( 126726), false);
                                       ...
                                       boolean bIsRwd )
   {
      ...
      com.quilmesportal.GxWebStd.set_html_headers( httpContext, nContentType, sCacheCtrl, sCacheExp);
      httpContext.setStream();
      if ( nContentType == 0 )
      {
                                        ...
                                        String sCallerPgm )
   {
      ...
      com.quilmesportal.GxWebStd.classAttribute( httpContext, sClassString);
      com.quilmesportal.GxWebStd.styleAttribute( httpContext, sTextAreaStyleString);
      ...
      com.quilmesportal.GxWebStd.gx_ctrl_attribute( httpContext, sCtrlName, "maxlength", sLength, false);
      if ( nEnabled == 0 )
      {
         ...
         com.quilmesportal.GxWebStd.gx_start_js_anchor( httpContext, nJScriptCode, sEventJsCode, "", sLinkURL, sLinkTarget, "");
         if ( nFormat == 0 )
         {
         ...
         com.quilmesportal.GxWebStd.gx_end_js_anchor( httpContext, sEventJsCode, "", sLinkURL);
         httpContext.writeText( "</span>") ;
      }
   }
                                      ...
                                      String sCallerPgm )
   {
      ...
      com.quilmesportal.GxWebStd.classAttribute( httpContext, sClassString+"Title");
      httpContext.writeText( ">") ;
      httpContext.writeText( sCaption) ;
      httpContext.writeText( "</legend>") ;
   }
                                        ...
                                        String sScroll )
   {
      ...
      if ( nWidth > 0 )
      {
         sStyleString = sStyleString + "width:" + GXutil.ltrim( GXutil.str( nWidth, 10, 0)) + sWidthUnit + ";" ;
      }
      if ( nHeight > 0 )
      {
         sStyleString = sStyleString + "height:" + GXutil.ltrim( GXutil.str( nHeight, 10, 0)) + sHeightUnit + ";" ;
      }
   ...
   public static void gx_form_group_start( HttpContext httpContext ,
                                           int nLabelPosition )
   {
      if ( nLabelPosition != 0 )
      {
   ...
   public static void gx_form_group_end( HttpContext httpContext ,
                                         int nLabelPosition )
   {
      if ( nLabelPosition != 0 )
      {
